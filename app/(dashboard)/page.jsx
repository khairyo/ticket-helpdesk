  ...
  return (
    <main>
      ...
      <div className="card">
        ...
        <p>Please join us in welcoming Khai Ryo, the newest addition to our web development team! We are thrilled to have her on board, and are already looking forward to the fantastic projects she is bringing to life. With a wealth of skills and a passion for innovation, Khai Ryo is set to embark on numerous exciting endeavors that will undoubtedly enhance our web development landscape. Stay tuned for the amazing work she has in store for us!</p>
      </div>
      <div className="card">
        <h3>🌐 Tech Marvels Unveiled at the Digital Innovation Expo! 🚀</h3>
        <p>Get ready to immerse yourself in the ultimate tech extravaganza! The Digital Innovation Expo is just around the corner, and the excitement is palpable. This year, we are thrilled to announce that groundbreaking products and technologies will take center stage! 
        <br /><br />
        ...
        <br /><br />
        As you step into the convention, be prepared to witness the unveiling of products that will redefine the way we live, work, and connect. It is not just a showcase, but an experience that will leave you inspired and awestruck.
        <br /><br />
